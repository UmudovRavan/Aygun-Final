  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        ink: { 50:'#f8fafc',100:'#f1f5f9',200:'#e2e8f0',300:'#cbd5e1',400:'#94a3b8',500:'#64748b',600:'#475569',700:'#334155',800:'#1e293b',900:'#0f172a',950:'#0a1120' },
      },
      backgroundImage: {
        'gradient-primary': 'linear-gradient(135deg, #2563eb 0%, #3b82f6 100%)',
        'gradient-hero': 'linear-gradient(135deg, #1e3a8a 0%, #2563eb 50%, #14b8a6 100%)',
      },
      boxShadow: {
