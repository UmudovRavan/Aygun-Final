    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-primary-50/60 to-white dark:from-ink-950 dark:to-ink-900 px-4 relative">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="card p-8">
          ...
          <button onClick={() => { localStorage.setItem('user', 'google'); navigate('/onboarding'); }} className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border-2 border-surface-200 dark:border-surface-700 text-surface-700 dark:text-surface-200 font-medium hover:bg-surface-50 dark:hover:bg-surface-800 transition-colors mb-4">
