...
const faqs = [
  ...
  { q: 'How does the hearts system work?', a: 'You start each quiz with 5 hearts. Each wrong answer costs one heart. When you run out, you can wait for them to refill or upgrade to Pro for unlimited hearts. Hearts do not affect reading stories — only quizzes.' },
